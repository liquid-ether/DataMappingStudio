...
| | |
|---|---|
| Current version | **v1.8.1** — graceful metadata-editor error handling + add-column validation |
| Build | `dotnet build DataMappingStudio.slnx` — clean |
| Tests | `dotnet test DataMappingStudio.slnx` — 205 passing (+5 E2E skipped unless `DMS_E2E=1`) |
